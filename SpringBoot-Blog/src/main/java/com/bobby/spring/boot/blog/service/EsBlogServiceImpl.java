...
import com.bobby.spring.boot.blog.repository.es.EsBlogRepository;
import com.bobby.spring.boot.blog.vo.TagVO;
...
public class EsBlogServiceImpl implements EsBlogService {
	...
	private ElasticsearchTemplate elasticsearchTemplate=new ElasticsearchTemplate(null);
	
	@Autowired
	private UserService userService;
	
//	FileSystemXmlApplicationContext context = new FileSystemXmlApplicationContext("src/main/resources/elasticsearchTemplate.xml");
////	@Autowired
//	private ElasticsearchTemplate elasticsearchTemplate = (ElasticsearchTemplate) context.getBean("es");
